...
assert_value!(tokio::sync::watch::WeakSender<NN>: !Send & !Sync & Unpin);
assert_value!(tokio::sync::watch::WeakSender<YN>: !Send & !Sync & Unpin);
assert_value!(tokio::sync::watch::WeakSender<YY>: Send & Sync & Unpin);
