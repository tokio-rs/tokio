...
async_assert_fn!(tokio::sync::Semaphore::acquire_permits(_, usize): Send & Sync & !Unpin);
async_assert_fn!(tokio::sync::Semaphore::acquire_permits_owned(_, usize): Send & Sync & !Unpin);
