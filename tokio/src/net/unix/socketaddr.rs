...
impl SocketAddr {
    ...
    ///
    /// On Linux/Android, allows the path to start with a leading `\0` to declare
    ...
    /// Extracts the inner standard library socket address struct
    pub fn into_std(self) -> StdSocketAddr {
        self.0
    }
